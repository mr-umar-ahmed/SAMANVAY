...
export const TOUR_STEPS: Partial<Record<PortalId, Localised>> = {
  planning: {
    en: [
      ...
      { target: 'weekly-send', route: '/app/planning/weekly', title: 'Send to Control', body: 'When the week looks right, send it. Each department concurs on its blocks, then the Section Controller grants them.' },
      { target: 'optimiser-run', route: '/app/planning/optimiser', title: 'Tune and compare', body: 'Change the objective weights or the JPO rules, run a candidate, and compare it with the working plan before adopting it.' },
    ...
    hi: [
      ...
      { target: 'weekly-send', route: '/app/planning/weekly', title: 'नियंत्रण को भेजें', body: 'सप्ताह ठीक लगे तो भेजें। हर विभाग अपने ब्लॉक पर सहमति देता है, फिर अनुभाग नियंत्रक प्रदान करते हैं।' },
      { target: 'optimiser-run', route: '/app/planning/optimiser', title: 'समायोजित करें और तुलना करें', body: 'उद्देश्य भार या JPO नियम बदलें, एक विकल्प चलाएँ और अपनाने से पहले चालू योजना से तुलना करें।' },
