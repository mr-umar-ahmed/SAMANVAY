...
export const ROLES: Record<RoleId, Role> = {
  SECTION_CONTROLLER: { id: 'SECTION_CONTROLLER', label: { en: 'Section Controller', hi: 'अनुभाग नियंत्रक' }, portal: 'control', can: ['grant', 'lock', 'issueCaution', 'execute', 'triage'] },
